...
set_target_properties(cpr::cpr PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libcpr.1.10.4.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libcpr.1.dylib"
  )

list(APPEND _cmake_import_check_targets cpr::cpr )
list(APPEND _cmake_import_check_files_for_cpr::cpr "${_IMPORT_PREFIX}/lib/libcpr.1.10.4.dylib" )
